...
public class Gmail extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circleImageView = findViewById(R.id.gmail_profile);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(Gmail.this);
                                ...
                                Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
                                    ...
                                    public void onResult(@NonNull Status status) {
                                        if(status.isSuccess()){
                                            ...
                                            Toast.makeText(Gmail.this, "Logged out successfully!", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(Gmail.this, MainActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }else{
                                            Toast.makeText(Gmail.this, "Log out failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
